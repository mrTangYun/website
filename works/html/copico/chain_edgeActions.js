...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         ...
         yepnope({
         				nope:["js/jquery-1.8.2.min.js","js/dist/js/swiper.js","http://vjs.zencdn.net/4.12/video-js.css","http://vjs.zencdn.net/4.12/video.js","css/main.css","js/common.js"],
         				complete:function(){
         					Copico.chainPageReady(sym);
...
})(window.jQuery || AdobeEdge.$, AdobeEdge, "EDGE-36914966");