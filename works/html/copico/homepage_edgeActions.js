   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "document", "compositionReady", function(sym, e) {
         // insert code to be run when the composition is fully loaded here
                  ...
                  yepnope({
                           	nope:["js/jquery-1.8.2.min.js","js/common.js"],
                           	complete:function(){
         								
         								Copico.homePageReady(sym);
                                 /*
                                 jQuery(".floatCopico").each(function(index, el) {
                                    console.log(jQuery(this)[0].style.transform);
                                 });
         								*/
                           	}
                           });
...
})(window.jQuery || AdobeEdge.$, AdobeEdge, "EDGE-32078184");